...
use mikasto\imagemanager\assets\ImageManagerModuleAsset;
use mikasto\imagemanager\models\ImageManager;
use mikasto\imagemanager\models\ImageManagerSearch;
...
//
    ...
    public function actionGetOriginalImage()
    {
        ...
        $model = $this->findModel($ImageManager_id);
        //set return
        $return = \Yii::$app->imagemanager->getImagePath($model->id,
